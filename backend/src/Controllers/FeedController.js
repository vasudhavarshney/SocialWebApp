...
module.exports = {
  async show(req, res) {
    ...
    console.log("hererrrrrrrrrrrrrrrrrrrrr-->",{user,array,photos})
  ...
  async showFollow(req, res) {
    ...
    console.log("hererrrrrrrrrrrrrrrrrrrrr-->",user)
    let array = user.getFollows.map(obj => {
      return obj.user_to;
    });
    ...
    console.log("hererrrrrrrrrrrrrrrrrrrrr-->",array,user.getFollows)
